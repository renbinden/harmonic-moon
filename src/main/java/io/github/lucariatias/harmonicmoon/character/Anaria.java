...
public class Anaria extends Character {
    ...
    public Anaria(HarmonicMoon harmonicMoon) {
        super(harmonicMoon, "Anaria", 128, Gender.FEMALE, Job.WARRIOR, new SpriteSheet(harmonicMoon, "/characters/anaria.png", 32, 16), new SpriteSheet(harmonicMoon, "/characters/anaria-fight.png", 64, 64));
    }
